...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name"><?php echo e($department->$view_col); ?></h4>
					<!-- <div class="row stats">
		...
		<div class="col-md-1 actions">
			<?php if(LAFormMaker::la_access("Departments", "edit")) { ?>
				<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/departments/'.Crypt::encrypt($department->id).'/edit')); ?>" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			<?php } ?>
			
			<?php if(LAFormMaker::la_access("Departments", "delete")) { ?>
				<?php echo e(Form::open(['route' => [config('laraadmin.adminRoute') . '.departments.destroy',Crypt::encrypt($department->id)], 'method' => 'delete', 'style'=>'display:inline'])); ?>
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="<?php echo e(url(config('laraadmin.adminRoute') . '/departments')); ?>" data-toggle="tooltip" data-placement="right" title="Back to Departments"><i class="fa fa-chevron-left"></i></a></li>
				...
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						<?php if(Auth::user()->hasRole('SUPER_ADMIN')): ?>
							<?php echo LAFormMaker::display($module, 'dept_type'); ?>
