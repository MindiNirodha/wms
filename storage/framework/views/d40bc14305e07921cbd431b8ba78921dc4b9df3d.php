<?php $__env->startSection("contentheader_title", "Primary Posts"); ?>
<?php $__env->startSection("contentheader_description", "Primary Posts listing"); ?>
<?php $__env->startSection("section", "Primary Posts"); ?>
<?php $__env->startSection("sub_section", "Listing"); ?>
<?php $__env->startSection("htmlheader_title", "Primary Posts Listing"); ?>

<?php $__env->startSection("headerElems"); ?>
<?php if(LAFormMaker::la_access("Primary_Posts", "create")) { ?>
	<button class="btn btn-success btn-sm pull-right add-primary" data-toggle="modal" data-target="#AddModal">Add Primary Post</button>
<?php } ?>
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog primary-post-form" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">Add Primary Post</h4>
			</div>
			<?php echo Form::open(['action' => 'LA\Primary_postsController@store', 'id' => 'primary_post-add-form']); ?>
...
$(function () {
	...
	$("#example1").DataTable({
        ...
        serverSide: true,
        ajax: {
            	"url": "<?php echo e(url(config('laraadmin.adminRoute').'/primary_post_dt_ajax')); ?>",	
            	"type": "GET",
	...
	$(".primary-post-form .form-group:nth-last-of-type(1) input").removeClass("numberbox-primary");
	...
	$("#primary_post-add-form").validate({
...
<?php $__env->stopPush(); ?>
<style type="text/css">
	.primary-post-form .box-body{
		display: inline-block;
	}
	.primary-post-form .form-group{
		display: inline-block;
		display: inline-block;
    	margin-right: 10px;
    	width: 58px;	
	...
	.primary-post-form .form-group label{
		font-size: 12px;
	}
	
	
	.primary-post-form .form-group:nth-of-type(1) {
		display: block;
		margin-right:0;
    	width:100%;
	}

	.primary-post-form .form-group:nth-of-type(2) {
		display: block;
		margin-right:0;
    	width:100%;
	}

	.primary-post-form .form-group:nth-last-of-type(1) {
