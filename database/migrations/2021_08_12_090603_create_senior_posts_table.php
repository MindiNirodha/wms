...
class CreateSeniorPostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Senior_posts", 'senior_posts', 'institute_name', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('senior_posts')) {
            Schema::drop('senior_posts');
        }
    }
}
