...
class CreateSecondaryPostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Secondary_posts", 'secondary_posts', 'institute_name', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('secondary_posts')) {
            Schema::drop('secondary_posts');
        }
    }
}
