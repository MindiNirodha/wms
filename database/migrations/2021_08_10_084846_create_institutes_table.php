...
class CreateInstitutesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Institutes", 'institutes', 'ins_name', 'fa-cube', [
            ["ins_name", "Name", "TextField", false, "", 0, 256, true],
            ["parent_min", "Parent Ministry", "Dropdown", false, "", 0, 0, true, "@departments"],
        ]);
