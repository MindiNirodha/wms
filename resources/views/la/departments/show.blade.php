	...
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Departments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/departments/'.Crypt::encrypt($department->id).'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Departments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.departments.destroy',Crypt::encrypt($department->id)], 'method' => 'delete', 'style'=>'display:inline']) }}
