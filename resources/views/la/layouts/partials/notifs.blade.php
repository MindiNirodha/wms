				...
				@else
					...
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="{{(asset('la-assets/img/user.png'))}}" class="user-image" alt="User Image"/>
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								<img src="{{(asset('la-assets/img/user.png'))}}" class="img-circle" alt="User Image" />
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="{{ url(config('laraadmin.adminRoute') . '/users/') .'/'. Crypt::encrypt(Auth::user()->id) }}" class="btn btn-default btn-flat">Profile</a>
								</div>
