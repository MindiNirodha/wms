...
@section("contentheader_title", "Primary Posts")
@section("contentheader_description", "Primary Posts listing")
@section("section", "Primary Posts")
@section("sub_section", "Listing")
@section("htmlheader_title", "Primary Posts Listing")

@section("headerElems")
@la_access("Primary_Posts", "create")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog primary-post-form" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\Primary_postsController@store', 'id' => 'primary_post-add-form']) !!}
...
$(function () {
	...
	$("#example1").DataTable({
        ...
        serverSide: true,
        ajax: {
            	"url": "{{ url(config('laraadmin.adminRoute').'/primary_post_dt_ajax')}}",	
            	"type": "GET",
