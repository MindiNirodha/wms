...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $senior_post->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Senior_posts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/senior_posts/'.$senior_post->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Senior_posts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.senior_posts.destroy', $senior_post->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/senior_posts') }}" data-toggle="tooltip" data-placement="right" title="Back to Senior posts"><i class="fa fa-chevron-left"></i></a></li>
