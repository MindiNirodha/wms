...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $secondary_post->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Secondary_posts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/secondary_posts/'.$secondary_post->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Secondary_posts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.secondary_posts.destroy', $secondary_post->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/secondary_posts') }}" data-toggle="tooltip" data-placement="right" title="Back to Secondary posts"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'institute_name')
						@la_display($module, 'designation')
						@la_display($module, '2005')
						@la_display($module, '2006')
						@la_display($module, '2007')
						@la_display($module, '2008')
						@la_display($module, '2009')
						@la_display($module, '2010')
						@la_display($module, '2011')
						@la_display($module, '2012')
						@la_display($module, '2013')
						@la_display($module, '2014')
						@la_display($module, '2015')
						@la_display($module, '2016')
						@la_display($module, '2017')
						@la_display($module, '2018')
						@la_display($module, '2019')
						@la_display($module, '2020')
						@la_display($module, '2021')
