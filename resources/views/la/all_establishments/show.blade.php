...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $all_establishment->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("All_establishments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/all_establishments/'.$all_establishment->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("All_establishments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.all_establishments.destroy', $all_establishment->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/all_establishments') }}" data-toggle="tooltip" data-placement="right" title="Back to All establishments"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'senior')
						@la_display($module, 'secondary')
						@la_display($module, 'teritory')
						@la_display($module, 'primary')
